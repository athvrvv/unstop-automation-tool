...
async function main() {
    ...
    tab = pages[0];
    await tab.goto("https://unstop.com/");
    ...
    tab.goto("https://unstop.com" + app_urls[1]);
...
async function application(data) {
    ...
    await tab.goto("https://unstop.com/the-grand-summer-internship-fair");
...
async function apply(url, data) {
    await tab.goto("https://unstop.com" + url);
